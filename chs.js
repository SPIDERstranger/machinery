...
var cnItems = {
    ...
    "Unlocks Lifeforms Scanner from the start": "从一开始就解锁 生命形式扫描仪",
    ...
    "Floor Administrator Training I": "楼层管理员训练 I",
    "Floor Administrator Training II": "楼层管理员训练 II",
    ...
    "Game data reset. Reload page.": "游戏数据已重置。 请刷新重新加载页面。",
    "A group of visitors was sighted hiding under the Electric generator. Security has been informed about the incident.": "有人看到一群游客躲在发电机下面。 安全部门已被告知该事件。",
    "A prominent writer suggests that chief engineers should be kept away from machinery because \"they know too much\"": "一位著名作家建议首席工程师应该远离机器，因为“他们知道的太多了”",
    "Keyboard shortcuts": "键盘快捷键",
    "to start/restart generators": "去启动/重启发电机",
    "use": "使用",
    "\"My bad manners? Approved by my chief\" - engineer": "“我的不礼貌？我的主管批准了” - 工程师",
    "Engineer's log: A handful of non-organic isopods are forming weird shapes on the magnetron": "工程师日志：少数非有机等足动物在磁控管上形成奇怪的形状",
    "auto-buy is excellent for upgrading in the beginning, but you might want to upgrade specific generators manually from time to time": "自动购买非常适合一开始的升级，但您可能需要不时手动升级特定的生成器",
    "Scientists are looking into using particle collectors as collectors of particles": "科学家正在研究使用粒子收集器作为粒子收集器",
    "Scientists are looking into using foundry furnace to provide lighting source for scribes": "科学家正在研究使用铸造炉为抄写员提供光源",
    "Several items disappeared from the Research Lab. An unnamed chief engineer claims he was sold one of the items by a floor administrator": "几件物品从研究实验室消失了。 一位不愿透露姓名的总工程师声称他被一名楼层管理员出售了其中一件物品",
    "floor administrators have set up guard posts to protect the Battery from cable lizard packs": "楼层管理员设置了岗哨，以保护电池免受电缆蜥蜴包的伤害",
    "\"Respect your radiator and it will radiate respect back at you\" - chief engineer": "\“尊重你的散热器，它会回敬你”——总工程师",
    "\"Warmth of the radiator is like the warmth of a parent's heart\" - chief engineer": "“暖气片的温暖，就像父母心的温暖”——总工程师",
    "A local comedian suggests that plastic flies are good for the economy": "一位当地喜剧演员认为塑料苍蝇对经济有利",
    "bars opened its doors to non-organics": "酒吧向非有机食品敞开大门",
    "Engineer's log: A horde of plastic flies has just flown straight into the furnace": "工程师日志：一大群塑料苍蝇刚刚飞入熔炉",
    "Non-organic eggs of unknown insect species were discovered on one of the pipes of the Gravity generator. Scientists are building a 3D model of the non-organic creature": "在重力发生器的一根管道上发现了未知昆虫种类的非有机卵。 科学家们正在构建这种非有机生物的 3D 模型",
    "to toggle auto-buy": "切换自动购买",
    "Scientists are looking into using particle collectors as tools to trap small objects, such as particles": "科学家们正在研究使用粒子收集器作为捕获小物体的工具，例如粒子",
    "EU Parliament has just announced that engineers cannot be classified as weirdos since \"there's nothing weird about them\"": "欧盟议会刚刚宣布，工程师不能被归类为怪人，因为“他们没有什么奇怪的”",
    "floor administrators have set up guard posts to protect the Foundry from nut beetle hoards": "楼层管理员设立了岗哨，以保护铸造厂免受坚果甲虫囤积的侵害",
    "A UFO was spotted hovering over one of the generators. It's still there now": "一个不明飞行物被发现在其中一个发电机上空盘旋。 它现在还在",
    "\"I just wait for the buttons to activate\" - operator": "\"我只是等待按钮激活\" - 操作员",
    "Scientists consider using magnetrons to build a perpetual motion machine": "科学家考虑使用磁控管制造永动机",
    "Scientists consider using radiators as comfort pets": "科学家考虑将散热器用作舒适的宠物",
    "an unnamed chief engineer claims to have drank more coffee than anyone else in the history of mankind. The statement was later retracted.": "一位不愿透露姓名的总工程师声称，他喝的咖啡比人类历史上任何人都多。 该声明后来被撤回。",
    "EU Parliament is deliberating on whether magnetrons can be used in casinos as slot machines": "欧盟议会正在审议磁控管是否可以在赌场用作老虎机",
    "a non-organic isopod infused with gold was sold for an undisclosed sum of money": "一种注入黄金的非有机等足类动物以未公开的金额出售",
    "\"That's what my chief told me to do\" - engineer": "“这就是我的主管让我做的事情”——工程师",
    "Talk show host insists that the low-frequency hum of the Plasma generator is a conspiracy": "脱口秀主持人坚称等离子发生器低频嗡嗡声是阴谋",
    "\"We are all professionals here, especially the operators\" - engineer": "“我们都是专业人士，尤其是操作人员”——工程师",
    "Engineer's log: A connected chain of cable lizards attempted to devour the radiator. Again": "工程师日志：一条相连的电缆蜥蜴试图吞噬散热器。 再次",
    "Talk show host considers if plastic flies are good for the economy": "脱口秀主持人考虑塑料苍蝇是否对经济有利",
    "A UFO was spotted hovering over one of the generators. It was later identified and became an IFO": "一个不明飞行物被发现在其中一个发电机上空盘旋。 后来被确定并成为IFO",
    "Scientists are looking into using magnetrons to fix climate change": "科学家们正在研究使用磁控管来解决气候变化问题",
    "Magnetrons have been voted the leading tech that starts with the letter \"m\", second only to magnets": "磁控管被评为以字母“m”开头的领先技术，仅次于磁铁",
    "\"We should introduce the non-organic isopod into the foundry ecosystem\", says researcher": "“我们应该将非有机等足动物引入铸造生态系统”，研究人员说",
    "A homeless guy considers if nut beetles are programmed to search for a mating bolt": "一个无家可归的人考虑是否对坚果甲虫进行编程以寻找配对螺栓",
    "\"I'm not yet allowed to be around the particle collector\" - operator": "\"我还不允许在粒子收集器周围\" - 操作员",
    "A gathering of lawyers was spotted hiding under the Gravity generator. Security has been informed about the incident.": "一群律师被发现躲在重力发生器下。 安全部门已被告知该事件。",
    "A study finds that if left unattended, machinery goes out of order": "一项研究发现，如果无人看管，机器就会出现故障",
    "Engineer's log: A handful of mutated worms and non-organic isopods are crawling about on the magnetron": "工程师日志：少数变异的蠕虫和非有机等足类动物在磁控管上爬行",
    "Engineer's log: A horde of plastic flies was recycled into components": "工程师日志：一大群塑料苍蝇被回收成组件",
    "when the Antimatter Amplifier becomes x100 or larger, the initial Power limit is set to a higher value, dependent on all-time energy mined.": "当反物质放大器变为 x100 或更大时，初始功率限制将设置为更高的值，具体取决于所有时间开采的能量。",
    "tracks of mutated worms were spotted on the wall of the Electric generator": "在发电机的墙上发现了变异蠕虫的踪迹",
    "A prominent writer insists that they have seen an unseen spider": "一位著名作家坚称他们看到了一只看不见的蜘蛛",
    "Engineer's log: A googol of nanobots has populated the lower chambers of the particle collector": "工程师日志：一群纳米机器人在粒子收集器的下部腔室中填充",
    "EU Parliament began deliberations on replacing some of the outdated regulation regarding the rights of non-organics": "欧盟议会开始审议更换一些关于非有机物权利的过时法规",
    "a pipe burst in section 46, please keep calm or go panic in another section. Thank you": "第 46 段管道爆裂，请保持冷静或在另一段恐慌。 谢谢",
    "Engineer's log: A significant amount of nanobots": "工程师日志：大量纳米机器人",
    "An unidentified crawling object (UCO) was spotted on the Radiator": "在散热器上发现了一个不明爬行物体 (UCO)",
    "\"Plastic flies are a solution to the shortage of artificial burgers\", says researcher": "“塑料苍蝇是人造汉堡短缺的解决方案”，研究人员说",
    "Someone online wonders if non-organic isopods are an evolved lifeform": "Someone online wonders if non-organic isopods are an evolved lifeform",
    "A resident mechanic wonders if Pek Monster is an amalgamation of all the known non-organic lifeforms": "一位常驻机械师想知道 Pek 怪物 是否是所有已知非有机生命形式的融合体",
    "Engineer's log: A group of mutated worms and non-organic isopods are glowing when near the magnetron": "工程师日志：一群变异的蠕虫和非有机等足类动物在靠近磁控管时正在发光",
    "the Engineering Den is not a single floor: anything below it is known as the \"jungle\", but is only accessible to floor administrators?": "工程巢穴不是一层楼：它下面的任何东西都被称为“丛林”，但只有楼层管理员才能进入？",
    "EU Parliament is considering whether magnetron is a type of a slot machine": "欧盟议会正在考虑磁控管是否属于老虎机",
    "A fellow engineer suggests that duotronic butterflies are actually monotronic": "一位工程师同事认为双电子蝴蝶实际上是单电子的",
    "Scientists suggest using foundry furnace to make Christmas cookies": "科学家建议使用铸造炉制作圣诞饼干",
    "Water drops accumulated on the Plasma generator were shown to be a direct consequence of vibrations from techno blasted by engineers": "等离子发生器上积聚的水滴被证明是工程师爆破技术振动的直接结果",
    "Scientists are looking into using foundry furnace to produce swords for fantasy conventions": "科学家们正在研究使用铸造炉来生产用于幻想公约的剑",
    "A fellow engineer insists that the low-frequency hum of the Plasma generator is a conspiracy": "一位工程师同事坚持认为等离子发生器的低频嗡嗡声是一个阴谋",
    "A local comedian maintains that unseen spiders meet the definition of a veridical paradox": "一位当地喜剧演员坚持认为看不见的蜘蛛符合真实悖论的定义",
    "EU Parliament was grilled by the press regarding the rights of non-organics": "欧盟议会就非有机物权利受到媒体质询",
    "a confectionery opened its doors to non-organics": "一家糖果店向非有机食品敞开大门",
    "Engineer's log: A cloud of plastic flies was just eaten by an unknown organism": "工程师日志：一团塑料苍蝇刚刚被未知生物吃掉",
    "debate between engineers occurred in section 895, please keep calm or go panic in another section. Thank you": "工程师之间的争论发生在第 895 节，请保持冷静，否则在另一节恐慌。 谢谢",
    "Engineer's log: A connected chain of cable lizards is suspected ot trying to steal the radiator. Again": "工程师日志：一条相连的电缆蜥蜴链被怀疑试图偷走散热器。 再次",
    "A homeless guy believes that the low-frequency hum of the Plasma generator is a sign of emerging intelligence": "一个流浪汉认为等离子发生器的低频嗡嗡声是新兴智能的标志",
    "A resident mechanic believes that plastic flies are good for the economy": "一位居民机械师认为塑料苍蝇对经济有好处",
    "\"I heard all sorts of mysterious non-organics live in the particle collector\" - operator": "“我听说粒子收集器里住着各种神秘的非有机物”——操作员",
    "A conspiracy theorist wonders if floor administrators have developed special weaponry to deal with unruly non-organics": "一位阴谋论者想知道楼层管理员是否开发了特殊武器来处理不守规矩的非有机物",
    "Engineer's log: A gathering of cable lizards is suspected ot trying to steal the radiator. Again": "工程师日志：怀疑一群电缆蜥蜴试图偷取散热器。 再次",
    "Engineer's log: A number of non-organic isopods are gnawing on the big magnetron button": "工程师日志：大量非有机等足类动物正在啃食大磁控管按钮",
    "Plasmic frogs were shown to be a direct consequence of UFOs detected in the Engineering Den": "等离子青蛙被证明是在工程巢穴中发现的不明飞行物的直接后果",
    "Scientists suggest using magnetrons to fix climate change": "科学家建议使用磁控管来解决气候变化问题",
    "Scientists suggest using radiators as the inlikely science communicators": "科学家建议使用散热器作为不太可能的科学传播者",
    "section 203 is now open, but beware": "203 节现已开放，但请注意",
    "some folks walked into an expanding portal to another dimension. Found themselves in the middle of last Tuesday": "有些人走进了通往另一个维度的不断扩大的门户。 发现自己在上周二的中间",
    "Someone online concludes that nut beetles are programmed to search for a mating bolt": "有人在网上得出结论，坚果甲虫被编程为寻找交配螺栓",
    "Engineer's log: A swarm of plastic flies has just flown straight into the furnace": "工程师日志：一群塑料苍蝇刚刚飞入熔炉",
    "Scientists are looking into using radiators as bar stools": "科学家正在研究将散热器用作酒吧凳",
    "to offset working conditions, some floor administrators have been offered additional milk": "为了抵消工作条件，一些楼层管理员获得了额外的牛奶",
    "Engineer's log: A significant amount of nanobots has populated the lower chambers of the particle collector": "工程师日志：大量的纳米机器人已经占据了粒子收集器的下部腔室",
    "Someone online considers if Pek Monster is an amalgamation of all the known non-organic lifeforms": "有人在网上考虑 Pek 怪物 是否是所有已知非有机生命形式的融合",
    "section 383 is now partially consumed by an expanding portal to another dimension. Containment fields are currently being erected": "区域 383 部分现在被一个扩展的门户消耗到另一个维度。 目前正在建立收容场",
    "Hide details": "隐藏详情",
    "Low-frequency noises from below the Plasma generator were shown to be a direct consequence of the second law of thermodynamics": "来自等离子发生器下方的低频噪声被证明是热力学第二定律的直接结果",
    "Plasmic frogs were shown to be a direct consequence of strong opinions held by engineers about which type of bolt is better": "等离子青蛙被证明是工程师对哪种螺栓更好的强烈意见的直接结果",
    "A conspiracy theorist believes that plastic flies cannot be killed with a plastic flyswatter": "阴谋论者认为塑料苍蝇不能用塑料苍蝇拍杀死",
    "A homeless guy insists that duotronic butterflies are actually monotronic": "一个无家可归的人坚持认为双电子蝴蝶实际上是单电子的",
    "an unnamed chief engineer asserts that he had personally designed and assembled all the generators. The statement was later retracted.": "一位不愿透露姓名的总工程师声称他亲自设计并组装了所有发电机。 该声明后来被撤回。",
    "A local comedian claims that plastic flies are good for the economy": "一位当地喜剧演员声称塑料苍蝇对经济有利",
    "A study finds no health risks of occasional warping": "一项研究发现偶尔翘曲没有健康风险",
    "\"I just focus on the clicking\" - operator": "\"我只专注于点击\" - 操作员",
    "Several interns got lost in the Engineering Den last week. Search considered hopeless at this point": "几个实习生上周在工程中心迷路了。 搜索在这一点上被认为是无望的",
    "An amateur philosopher wonders if duotronic butterflies are actually monotronic": "一位业余哲学家想知道双电子蝴蝶是否真的是单电子的",
    "a bakery opened its doors to non-organics": "一家面包店向非有机食品敞开大门",
    "A gathering of lawyers was reported hiding under the Plasma generator. Security has been informed about the incident.": "据报道，一群律师躲在等离子发生器下。安全部门已被告知该事件。",
    "A homeless guy alleges that nut beetles are programmed to search for a mating bolt": "一个无家可归的家伙声称坚果甲虫被编程为寻找配对螺栓",
    "A homeless guy claims that cable lizards could be assembled into one really long cable": "一个流浪汉声称电缆蜥蜴可以组装成一根很长的电缆",
    "a non-organic isopod decorated with edible elements was sold at a black market": "一种装饰有可食用元素的非有机等足动物在黑市上出售",
    "A prominent writer insists that unseen spiders is a hoax perpetrated by overworked operators": "一位著名作家坚持认为，看不见的蜘蛛是过度劳累的操作员的骗局",
    "An unidentified crawling object (UCO) was spotted on the Particle Collector": "在粒子收集器上发现了一个身份不明的爬行物体 (UCO)",
    "an unnamed chief engineer declares himself to be the ultimate expert on everything. The statement was later retracted.": "一位不愿透露姓名的总工程师宣称自己是所有事情的终极专家。该声明后来被撤回。",
    "an unnamed chief engineer says it's all the government's fault. The statement was later retracted.": "一位不愿透露姓名的总工程师说这都是政府的错。该声明后来被撤回。",
    "Be especially attentive when attempting to debug the low-frequency hum of the Plasma generator so as not to be eaten by an unknown organism": "尝试调试等离子发生器的低频嗡嗡声时要特别注意，以免被未知生物吃掉",
    "debate between engineers occurred in section 262, please keep calm or go panic in another section. Thank you": "工程师之间的争论发生在第 262 节，请保持冷静，否则在另一个节中恐慌。谢谢",
    "leaks were shown to be a direct consequence of irresponsible engineering experiments": "泄漏被证明是不负责任的工程​​实验的直接后果",
    "there are over 70 registered non-organic lifeforms, but only 16 species have established populations": "已登记的非有机生命体有 70 多种，但只有 16 个物种建立了种群",
    "Your neighbor insists that plastic flies can be used for a variety of purposes in the home": "你的邻居坚持认为塑料苍蝇可以在家中用于多种用途",
    "A friendly discussion on the aesthetic qualities of duotronic butterflies will be held tomorrow": "明天将举行关于双电子蝴蝶美学品质的友好讨论",
    "Non-organic eggs of unknown insect species were discovered on one of the pipes of the Nuclear generator. Scientists are building a 3D model of the non-organic creature": "在核发电机的一根管道上发现了未知昆虫种类的无机卵。 科学家们正在构建这种非有机生物的 3D 模型",
    "A bunch of isopods was reported hiding under the Nuclear generator. No action is required": "据报道，一堆等足类动物躲在核发电机下面。 无需任何操作",
    "A person on the Internet maintains that unseen spiders meet the definition of a veridical paradox": "互联网上的一个人认为，看不见的蜘蛛符合真实悖论的定义",
    "A person on the Internet wonders if floor administrators have developed special weaponry to deal with unruly non-organics": "网上有人想知道楼层管理员是否开发了特殊武器来处理不守规矩的非有机物",
    "A UFO was spotted hovering over one of the generators. It was captured by floor administrators, but was then let go for unclear reasons": "一个不明飞行物被发现在其中一个发电机上空盘旋。 它被楼层管理员捕获，但随后因不明原因被释放",
    "Several managers got lost in the Engineering Den last week. Search considered hopeless at this point": "上周，几位经理在工程中心迷路了。 搜索在这一点上被认为是无望的",
    "Someone online considers if unseen spiders actually exist": "有人在网上考虑是否真的存在看不见的蜘蛛",
    "Talk show host concludes that non-organic isopods have evolved from some archaic computer technology": "脱口秀主持人总结非有机等足类动物是从一些古老的计算机技术进化而来的",
    "A fellow engineer considers if non-organic isopods have evolved from some archaic computer technology": "一位工程师同事考虑是否非有机等足类动物是从一些古老的计算机技术进化而来的",
    "A fellow engineer wonders if plastic flies can be used for a variety of purposes in the home": "一位工程师同事想知道塑料苍蝇是否可以在家中用于各种用途",
    "a floor administrator is seen commanding a tribe of nanobots": "一名楼层管理员正在指挥一个纳米机器人部落",
    "A homeless guy concludes that the low-frequency hum of the Plasma generator is a conspiracy": "一个流浪汉断定等离子发生器的低频嗡嗡声是一个阴谋",
    "A local comedian alleges that non-organic isopods have evolved from some archaic computer technology": "一位当地喜剧演员声称非有机等足类动物是从一些古老的计算机技术演变而来的",
    "A person on the Internet claims that the low-frequency hum of the Plasma generator is a sign of emerging intelligence": "网上有人声称等离子发生器的低频嗡嗡声是新兴智能的标志",
    "A prominent writer concludes that plastic flies can be used for a variety of purposes in the home": "一位著名作家得出结论，塑料苍蝇可用于家庭中的多种用途",
    "A referendum voices support for more research into engineer caves that have been spotted throughout the city": "全民投票支持对整个城市发现的工程师洞穴进行更多研究",
    "A resident mechanic alleges that non-organic life is more normal than organic becase \"they don't poop\"": "一位驻地机械师声称，非有机生活比有机生活更正常，因为“他们不拉屎”",
    "A study suggests that people who warp frequently experience warping more frequently": "一项研究表明，经常翘曲的人更频繁地经历翘曲",
    "An amateur philosopher believes that cable lizards could be assembled into one really long cable": "一位业余哲学家认为，电缆蜥蜴可以组装成一根非常长的电缆",
    "An amateur philosopher wonders if unseen spiders is a hoax perpetrated by overworked operators": "一位业余哲学家想知道看不见的蜘蛛是否是过度劳累的操作员的恶作剧",
    "an unclear event occured in section 140, please keep calm or go panic in another section. Thank you": "第140节发生了不明事件，请保持冷静或在另一节恐慌。谢谢",
    "An unidentified crawling object (UCO) was spotted under the Battery": "在电池下方发现了一个身份不明的爬行物体 (UCO)",
    "an unnamed chief engineer asserts that he had personally designed and assembled all non-organic lifeforms. The statement was later retracted.": "一位未透露姓名的总工程师声称他亲自设计并组装了所有非有机生命形式。该声明后来被撤回。",
    "Be careful when attempting to catch a non-organic isopod so as not to be eaten by an unknown organism": "尝试捕捉非有机等足类动物时要小心，以免被未知生物吃掉",
    "cable lizards are used as transportation by other non-organics": "电缆蜥蜴被其他非有机物用作运输工具",
    "floor administrators have set up guard posts to protect themselves from mutated worms invasions": "楼层管理员设置了岗哨，以保护自己免受变异蠕虫的入侵",
    "happy hour is happening": "欢乐时光正在发生",
    "mech ciliates can now be found in every device of the Power Plant": "机械纤毛虫现在可以在发电厂的每个设备中找到",
    "Non-organic isopods were shown to be a direct consequence of UFOs detected in the Engineering Den": "非有机等足类动物被证明是在工程巢穴中发现的不明飞行物的直接后果",
    "section 577 has been given a different number. Announcements to follow": "第 577 条被赋予了不同的编号。后续公告",
    "section 716 is now open, but beware": "第 716 节现已开放，但请注意",
    "Severed legs of a non-organic organism were discovered on one of the pipes of the Electric generator. Scientists are recommending a non-organic insecticide solution": "在发电机的一根管道上发现了一种非有机生物的断腿。科学家推荐一种非有机杀虫剂溶液",
    "Severed legs of a non-organic organism were discovered on one of the pipes of the Nuclear generator. Scientists ponder if there is any risk to the engineers in the area": "在核发电机的一根管道上发现了一种非有机生物的断腿。科学家们思考该地区的工程师是否有任何风险",
    "some folks walked into an expanding portal to another dimension. Came back as honest politicians": "有些人走进了通往另一个维度的不断扩大的门户。作为诚实的政治家回来",
    "Someone online wonders if non-organic isopods have evolved from some archaic computer technology": "网上有人想知道非有机等足类动物是不是从一些古老的计算机技术进化而来的",
    "Talk show host suggests that unseen spiders actually exist": "脱口秀主持人暗示实际上存在看不见的蜘蛛",
    "Talk show host wonders if non-organic life should be considered property theft: \"They incorporate our stuff into their bodies and then run away\"": "脱口秀主持人想知道非有机生命是否应该被视为财产盗窃：“他们将我们的东西融入他们的身体然后逃跑”",
    "to offset working conditions, some floor administrators have been offered additional trips to the local zoo to see some organics": "为了抵消工作条件，一些楼层管理员被提供额外的旅行到当地动物园看一些有机物",
    "Unseen spiders were shown to be a direct consequence of random neutrino collisions": "看不见的蜘蛛被证明是随机中微子碰撞的直接结果",
    "Your neighbor suggests that unseen spiders is a hoax perpetrated by overworked operators": "你的邻居认为看不见的蜘蛛是过度劳累的操作员的恶作剧",
    "\"This mess? Approved by my chief\" - engineer": "“这个烂摊子？我的主管批准了” - 工程师",
    "A fellow engineer suggests that floor administrators have developed special weaponry to deal with unruly non-organics": "一位工程师同事建议楼层管理员开发了特殊武器来处理不守规矩的非有机物",
    "A fellow engineer wonders if they have seen an unseen spider": "一位工程师同事想知道他们是否看到了一只看不见的蜘蛛",
    "a floor administrator witnessed the mating of unseen spiders. Counseling sessions have been set up": "一位楼层管理员目睹了看不见的蜘蛛的交配。已设立辅导班",
    "A group of isopods was reported hiding under the Gravity generator. Security has been informed about the incident.": "据报道，一群等足类动物躲在重力发生器下。安全部门已被告知该事件。",
    "A group of workers from the last shift was seen hiding under the Nuclear generator. No action is required": "看到上一班的一群工人躲在核发电机下。无需任何操作",
    "A homeless guy concludes that cable lizards could be assembled into one really long cable": "一个无家可归的家伙得出结论，电缆蜥蜴可以组装成一根很长的电缆",
    "A homeless guy suggests that non-organic isopods have evolved from some archaic computer technology": "一个无家可归的人认为非有机等足类动物是从一些古老的计算机技术进化而来的",
    "A local comedian considers if unseen spiders is a hoax perpetrated by overworked operators": "一位当地喜剧演员认为看不见的蜘蛛是否是过度劳累的操作员的恶作剧",
    "a nut beetle painted in rainbow colors was sold for a record sum of money": "一只涂成彩虹色的坚果甲虫以创纪录的价格售出",
    "A person on the Internet concludes that non-organic isopods have evolved from some archaic computer technology": "网上一个人总结说，非有机等足类动物是从一些古老的计算机技术进化而来的",
    "A resident mechanic concludes that the low-frequency hum of the Plasma generator is a sign of emerging intelligence": "一位驻地机械师得出结论，等离子发生器的低频嗡嗡声是新兴智能的标志",
    "A resident mechanic suggests that plasmic frogs could be an addition to a healthy post-apocalyptic diet": "一位常驻机械师认为，质蛙可能是世界末日后健康饮食的补充",
    "A study finds no health risks of infrequent warping": "一项研究发现不经常翘曲没有健康风险",
    "A study finds that frequent warping is beneficial to one's sex life": "一项研究发现，经常翘曲对性生活有益",
    "A study finds that the clicking of generators induces structured thinking": "一项研究发现，点击生成器会引发结构化思维",
    "A UFO was spotted hovering over one of the generators. It looked like a flying saucer, but on closer inspection bore more resemblance to a chicken": "一个不明飞行物被发现在其中一个发电机上空盘旋。它看起来像一个飞碟，但仔细观察更像一只鸡",
    "A UFO was spotted hovering over one of the generators. It was shot down by floor administrators and sold to an unnamed chief engineer": "一个不明飞行物被发现在其中一个发电机上空盘旋。它被楼层管理员击落并卖给了一位未透露姓名的总工程师",
    "Be mindful when attempting to debug the low-frequency hum of the Plasma generator so as not to fall into an open hatch": "尝试调试等离子发生器的低频嗡嗡声时要小心，以免掉入打开的舱口",
    "section 233 will be used for a local hacker convention": "第 233 节将用于本地黑客大会",
    "Someone online insists that plastic flies are good for the economy": "网上有人坚称塑料苍蝇对经济有利",
    "Strange noises from the Plasma generator were shown to be a direct consequence of the second law of thermodynamics": "等离子体发生器发出的奇怪噪音被证明是热力学第二定律的直接结果",
    "\"Do I know what I am doing? You bet. Just don't bet much!\" - engineer": "\“我知道我在做什么吗？你打赌。只是不要赌太多！\” - 工程师",
    "A bunch of isopods was sighted hiding under the Electric generator. Security has been informed about the incident.": "一群等足动物被发现藏在发电机下面。安全部门已被告知该事件。",
    "A conspiracy theorist insists that mutated worms are partially non-organic": "阴谋论者坚持认为变异的蠕虫部分是非有机的",
    "a duotronic butterfly decorated with edible elements was confiscated by authorities": "一只装饰有可食用元素的双电子蝴蝶被当局没收",
    "a flask of mech ciliates infused with gold was sold at a black market": "一瓶注入黄金的机械纤毛虫在黑市上出售",
    "A gathering of isopods was sighted hiding under the Nuclear generator. Security has been informed about the incident.": "一群等足类动物被发现藏在核发电机下面。安全部门已被告知该事件。",
    "A gathering of lawyers was reported hiding under the Nuclear generator. No action is required": "据报道，一群律师躲在核发电机下。无需任何操作",
    "A group of lawyers was spotted hiding under the Magnetron. Security has been informed about the incident.": "一群律师被发现躲在磁控管下。安全部门已被告知该事件。",
    "A group of workers from the last shift was sighted hiding under the Plasma generator. Security has been informed about the incident.": "有人看到上一班的一群工人躲在等离子发生器下面。安全部门已被告知该事件。",
    "A homeless guy suggests that non-organic isopods are an evolved lifeform": "一个无家可归的人认为非有机等足类动物是一种进化的生命形式",
    "A person on the Internet believes that duotronic butterflies are actually monotronic": "网上有人认为双电子蝴蝶其实是单电子的",
    "A person on the Internet considers if duotronic butterflies are actually monotronic": "网上一个人考虑双电子蝴蝶是否真的是单电子的",
    "A person on the Internet considers if floor administrators have developed special weaponry to deal with unruly non-organics": "网上有人在考虑楼层管理员是否开发了特殊武器来处理不守规矩的非有机物",
    "A person on the Internet suggests that Pek Monster is an amalgamation of all the known non-organic lifeforms": "网上有人说 Pek Monster 是所有已知的非有机生命形式的融合体",
    "A resident mechanic alleges that mutated worms are partially non-organic": "一名居民机械师声称变异的蠕虫部分是非有机的",
    "A resident mechanic claims that non-organic isopods are secretly organic": "一位居民机械师声称非有机等足类动物是秘密有机的",
    "A resident mechanic maintains that non-organic isopods are secretly organic": "一位常驻机械师坚持认为非有机等足类动物是秘密有机的",
    "A study finds that malnourished engineers perform better if offered free drinks": "一项研究发现，如果提供免费饮料，营养不良的工程师会表现得更好",
    "Be especially attentive when attempting to catch a non-organic isopod so as not to fall into an open hatch": "尝试捕捉非有机等足类动物时要特别小心，以免掉入敞开的舱口",
    "Be extra careful when attempting to catch a non-organic isopod so as not to get stuck": "尝试捕捉非有机等足类动物时要格外小心，以免卡住",
    "breakfast with doughnuts is happening": "甜甜圈早餐正在发生",
    "EU Parliament was grilled by the press regarding non-organic isopods as a potential food source for pets": "欧盟议会被媒体质疑非有机等足类动物是宠物的潜在食物来源",
    "Someone online concludes that mutated worms are partially non-organic": "网上有人断定变异的蠕虫部分是非有机的",
    "Talk show host believes that non-organic isopods are an evolved lifeform": "脱口秀主持人认为非有机等足类动物是进化的生命形式",
    "Talk show host believes that unseen spiders actually exist": "脱口秀主持人认为看不见的蜘蛛真的存在",
    "Traces of non-organic isopods were discovered on one of the pipes of the Gravity generator. Scientists are recommending a non-organic insecticide solution": "在重力发生器的一根管道上发现了非有机等足类动物的痕迹。科学家推荐一种非有机杀虫剂溶液",
    "Water drops accumulated on the Plasma generator were shown to be a direct consequence of random neutrino collisions": "等离子发生器上积聚的水滴被证明是随机中微子碰撞的直接结果",
    "": "",
    "": "",
    "": "",
    "": "",
